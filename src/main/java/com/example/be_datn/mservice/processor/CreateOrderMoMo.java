...
import com.example.be_datn.mservice.enums.*;
...
public class CreateOrderMoMo extends AbstractProcess<PaymentRequest, PaymentResponse> {
    ...
    public static PaymentResponse process(Environment env, String orderId, String requestId, String amount, String orderInfo, String returnURL, String notifyURL, String extraData, com.example.be_datn.mservice.enums.RequestType requestType, Boolean autoCapture) throws Exception {
        LogUtils.init();
        try {
    ...
    public PaymentRequest createPaymentCreationRequest(String orderId, String requestId, String amount, String orderInfo,
                                                           String returnUrl, String notifyUrl, String extraData, com.example.be_datn.mservice.enums.RequestType requestType, Boolean autoCapture) {
