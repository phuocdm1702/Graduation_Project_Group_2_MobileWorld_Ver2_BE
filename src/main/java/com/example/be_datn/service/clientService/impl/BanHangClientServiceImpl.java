...
//    }
    ...
    public HoaDonDetailResponse thanhToan(Integer idHD, HoaDonRequest hoaDonRequest) {
        ...
        Set<HinhThucThanhToanDTO> hinhThucThanhToans = hoaDonRequest.getHinhThucThanhToan();
        ...
        HinhThucThanhToanDTO hinhThucThanhToanDTO = hinhThucThanhToans.iterator().next();
        Integer phuongThucThanhToanId = hinhThucThanhToanDTO.getPhuongThucThanhToanId();
        if (phuongThucThanhToanId == null) {
            throw new RuntimeException("ID phương thức thanh toán không được để trống!");
        }
